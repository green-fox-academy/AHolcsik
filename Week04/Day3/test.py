...
class TestExtend(unittest.TestCase):
    ...
    def test_add_4_and_1_is_5(self):
        self.assertEqual(extend.add(3, 1), 4)

    def test_max_of_three_first(self):
        self.assertEqual(extend.max_of_three(4, 2, 3), 4)

    def test_max_of_three_second(self):
        self.assertEqual(extend.max_of_three(1, 4, 3), 4)

    def test_max_of_three_third(self):
        self.assertEqual(extend.max_of_three(3, 4, 5), 5)

    def test_median_four_a(self):
        self.assertEqual(extend.median([7,5,3,5]), 5)

    def test_median_four_b(self):
        self.assertEqual(extend.median([2,1,5,2]), 2)

    def test_median_five(self):
        self.assertEqual(extend.median([4,1,2,3,5]), 3)

    def test_is_vovel_a(self):
        self.assertTrue(extend.is_vovel('au'))
